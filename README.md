...
3. Extract and then delete the compressed folder and rename the decompressed folder as `Fallback-Domain-Redirect-w-UTM-Plugin` (remove `-master` from the end).
